...
NResistance = {
	...
	COMPLIANCE_GROWTH_BASE = 0.065, -- base compliance grow
...
NProduction = {
	...
	MAX_CIV_FACTORIES_PER_LINE = 50,	-- 15 #Max number of factories that can be assigned a single production line.
	...
	BASE_FACTORY_SPEED_MIL = 1, 				-- Base factory speed multiplier (how much hoi3 style IC each factory gives).
...
NBuildings = {
	...
	BASE_FACTORY_REPAIR = 0.3,			-- 0.3 Default repair rate before factories are taken into account
...
NMilitary = {
	...
	LAND_COMBAT_STR_ARMOR_ON_SOFT_DICE_SIZE = 32,   -- extra damage dice if our armor outclasses enemy
...
NAI = {
	...
	RESEARCH_BONUS_FACTOR = 5.0, 				-- To which extent AI should care about bonuses to research
